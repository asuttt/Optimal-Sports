...
import homeHero from '@/assets/unused/Center City/short.00_00_34_00.Still004-450x450.jpg';
...
export const classes = [
  ['Jab & Jam', 'Kick, punch, and dance through a sweaty cardio party'],
  ...
  ['Cardio Kickboxing', 'Punch, kick, and sweat through a high-energy cardio workout'],
  ...
  ['Indoor Cycling', 'Ride to the beat or tackle intervals in a heart-pumping indoor cycle session'],
  ...
  ['Pom Dance', 'Shake your poms and strut through playful, sassy dance routines'],
  ...
  ['Gentle Yoga', 'A slower-paced yoga practice that pairs mindful movement with breath'],
  ...
  ['HIIT', 'High-intensity interval training with a fresh mix of cardio and strength challenges'],
  ...
  ['Active Aging', 'Build strength, range of motion, agility, balance, and coordination with upbeat low-impact training'],
